    ...
    if (isset($_SESSION['idUsuario']) && !empty($_SESSION['idUsuario'])) {
        ...
        if ($stmt = $mysqli->prepare($sql)) {
            ...
            if ($stmt->execute()) {
                ...
                if (!$adm) {
                    echo "<script>alert('Acceso restringido, solo administradores.');</script>";
                } else {
                        ...
                        if ($stmtEliminarReseñas->execute()) {
                            ...
                            if ($stmtEliminarBiblio = $mysqli->prepare($sqlEliminarBiblio)) {
                                ...
                                if ($stmtEliminarBiblio->execute()) {
                                    ...
                                    echo "Error al eliminar el juego de la biblioteca personal.";
                                }
                            } else {
                                echo "Error en la preparación de la consulta.";
                            }
                        } else {
                            echo "Error al eliminar las reseñas.";
                        }
                    } else {
                        echo "Error en la preparación de la consulta.";
                    }
