...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["contraseña"]))){
        $contraseña_err = "Please enter your password";
    } else{
                ...
                <div class="tarjeta">
                  ...
                  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <div class="form-group">
                      <input type="email" name="correo" class="form-control <?php echo (!empty($correo_err)) ? 'is-invalid' : ''; ?>" aria-describedby="emailHelp" placeholder="Email" id="email" value="<?php echo $correo; ?>" required>
                      <span class="invalid-feedback"><?php echo $correo_err; ?></span>
                    </div>

                    <div class="form-group">
                      <input type="password" name="contraseña" class="form-control <?php echo (!empty($contraseña_err)) ? 'is-invalid' : ''; ?>" placeholder="Password" id="contraseña" value="<?php echo $contraseña; ?>" required>
                    ...
                    <div>
                      <p id="tienes" class="mb-0">You don't have an account? <a href="register.php" class="text-white-50 fw-bold">Sign up</a></p>
                    </div>
                  </form>
